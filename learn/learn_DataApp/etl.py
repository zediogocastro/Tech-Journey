...
def process_song_file(
    ...
    clean_artist_data = [
        (
            ...
            if pd.notna(raw_artist_data["artist_id"])
            else None
        ),
        (
            raw_artist_data["artist_name"]
            if pd.notna(raw_artist_data["artist_name"])
            else None
        ),
        (
            raw_artist_data["artist_location"]
            if pd.notna(raw_artist_data["artist_location"])
            else None
        ),
        (
            raw_artist_data["artist_latitude"]
            if pd.notna(raw_artist_data["artist_latitude"])
            else None
        ),
        (
            raw_artist_data["artist_longitude"]
            if pd.notna(raw_artist_data["artist_longitude"])
            else None
        ),
    ]
