...
if __name__ == "__main__":
    ...
    registry.add_vehicle_model_info("Tesla", "Model 3", 50_000, FuelType.ELECTRIC, 2021)
    registry.add_vehicle_model_info(
        "Volkswagen", "ID3", 35_000, FuelType.ELECTRIC, 2021
    )
    registry.add_vehicle_model_info("BMW", "520e", 60_000, FuelType.PETROL, 2021)
    registry.add_vehicle_model_info("Tesla", "Model Y", 55_000, FuelType.ELECTRIC, 2021)
